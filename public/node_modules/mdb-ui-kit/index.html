  ...
  <body>
    ...
    <div class="container main-page d-flex justify-content-center flex-wrap p-3 text-center">
      ...
      <div class="container d-flex justify-content-center content mb-5">
        <div class="col d-flex align-content-center flex-wrap text-center">
          <div class="col">
            ...
            <h2 class="main-color">سأساعدك في تحديد مستقبلك والوصول الى احلامك</h2>
          </div>
      ...
      <div class="container d-flex justify-content-center text-center ">
        <button type="button" class="btn btn-primary btn-rounded c-btn ps-5 pe-5 pt-2 pb-2 btn-block fa-2x  bg-main-color"><span class="fa-2x">يلا</span></button>
      </div>
      <!-- btn -->
    </div>
