        ...
        <form action="" method="post" class="align-content-center">
          ...
          <div class="container d-flex justify-content-center flex-wrap">
            ...
            <div class="gender bg-five-color mb-4 me-2 rounded-5">
                <img
            src="/node_modules/mdb-ui-kit/img/boy.png"
            height="80"
            alt="MDB Logo"
            loading="lazy"
            class=" top-40"
            />
            <input type="radio" id="age" name="age" value="boy" />
            ...
            <div class="gender bg-forth-color mb-4 ms-2 rounded-5">
                <img
            src="/node_modules/mdb-ui-kit/img/girl.png"
            height="80"
            alt="MDB Logo"
            loading="lazy"
            class=" top-40"
            />
            <input type="radio" id="age" name="age" value="girl " />
            <label class="btn btn-default third-color" for="a25"></label>
            </div>
          ...
          <button type="button" class="btn btn-primary btn-rounded pt-2 pb-2 btn-block bg-main-color"><span class="fa-2x">يلا نكمل</span></button>
          </div>
