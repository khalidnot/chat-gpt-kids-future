...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/node_modules/mdb-ui-kit/css/custom.css" />
  </head>
  <body>
    ...
    <nav class="navbar navbar-light bg-white shadow-none">
      ...
      <!-- back btn -->
        ...
        <form class="d-flex input-group w-auto">
          <img
            src="/node_modules/mdb-ui-kit/img/Group 24.png"
            height="40"
            alt="MDB Logo"
            loading="lazy"
          />
      ...
      <div class="container d-flex justify-content-center content mb-5 mt-3 text-center">
        <form action="" method="post" class="align-content-center">
          ...
          <div class="container d-flex justify-content-center flex-wrap">
            ...
            <input type="radio" id="age" name="age" value="انا عمري 12" />
            <label class="btn btn-default third-color" for="a25">12</label>
            </div>
            <div class="button mb-4">
            <input type="radio" id="age" name="age" value="انا عمري13 " />
            <label class="btn btn-default third-color" for="a25">13</label>
            </div>
            <div class="button mb-4">
            <input type="radio" name="age" value="انا عمري 14 ما التخصص المناسب لي ؟" />
          ...
          <button type="button" class="btn btn-primary btn-rounded pt-2 pb-2 btn-block bg-main-color"><span class="fa-2x">يلا</span></button>
          </div>
