...
<div class="container main-page d-flex justify-content-center flex-wrap p-3 text-center">
    ...
    <div class="container mt-5 mb-5">
        <div class="img-fluid">
            <svg xmlns="http://www.w3.org/2000/svg" width="194.465" height="173.127" viewBox="0 0 194.465 173.127">
    ...
    <div class="container d-flex justify-content-center content mb-5 mt-3 text-center">
        <form method="post" action="{{ route('users.subjectstore') }}" class="align-content-center">
            @csrf
            <div class="container mb-5">
                <label class="form-label mt-5 " for="typeText"><span class="main-color fa-2x">ايش المادة المفضلة لك؟</span></label>
            </div>

            <div class="container d-flex justify-content-center flex-wrap">
                <div class="button mb-4">
                    <input type="radio" id="subject" name="subject" value="math" />
                    <label class="btn btn-default third-color" for="a25">رياضيات</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" id="subject" name="subject" value="science" />
                    <label class="btn btn-default third-color" for="a25">علوم</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" name="subject" value="art" />
                    <label class="btn btn-default third-color" for="a25">فن</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" name="subject" value="english" />
                    <label class="btn btn-default third-color" for="a25">لغة انجليزية</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" name="subject" value="history" />
                    <label class="btn btn-default third-color" for="a25">تاريخ</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" name="subject" value="Arabic" />
                    <label class="btn btn-default third-color" for="a25">اللغة العربية</label>
                </div>
            </div>
            <div class="container mt-5">
                <button type="submit" class="btn btn-primary btn-rounded pt-2 pb-2 btn-block bg-main-color"><span class="fa-2x">يلا</span></button>
            </div>
