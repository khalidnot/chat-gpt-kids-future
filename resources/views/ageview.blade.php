...
<div class="container main-page d-flex justify-content-center flex-wrap p-3 text-center">
    ...
    <div class="container d-flex justify-content-center content mb-5 mt-3 text-center">
        <form method="post" action="{{ route('users.agestore') }}" class="align-content-center">
            @csrf
            <div class="container mb-5">
                <label class="form-label mt-5 " for="typeText"><span class="main-color fa-2x">كم عمرك؟</span></label>
            </div>

            <div class="container d-flex justify-content-center flex-wrap">
                <div class="button mb-4">
                    <input type="radio" id="age" name="age" value="12" />
                    <label class="btn btn-default third-color" for="a25">12</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" id="age" name="age" value="13" />
                    <label class="btn btn-default third-color" for="a25">13</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" name="age" value="14" />
                    <label class="btn btn-default third-color" for="a25">14</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" name="age" value="15" />
                    <label class="btn btn-default third-color" for="a25">15</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" name="age" value="16" />
                    <label class="btn btn-default third-color" for="a25">16</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" name="age" value="17" />
                    <label class="btn btn-default third-color" for="a25">17</label>
                </div>
            </div>
