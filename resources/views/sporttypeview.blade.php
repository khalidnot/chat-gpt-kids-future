...
<div class="container main-page d-flex justify-content-center flex-wrap p-3 text-center">
    ...
    <div class="container d-flex justify-content-center content mb-5 mt-3 text-center">
        <form method="post" action="{{ route('users.Sporttypetore') }}" class="align-content-center">
            @csrf
            <div class="container mb-5">
                <label class="form-label mt-5 " for="typeText"><span class="main-color fa-2x">هل تحب ممارسة الرياضة بشكل ؟</span></label>
            </div>

            <div class="container d-flex justify-content-center flex-wrap">
                <div class="button mb-4">
                    <input type="radio" id="subject" name="sport" value="Social person" />
                    <label class="btn btn-default third-color" for="a25">اجتماعي</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" id="subject" name="sport" value="antisocial person" />
                    <label class="btn btn-default third-color" for="a25">فردي</label>
                </div>
