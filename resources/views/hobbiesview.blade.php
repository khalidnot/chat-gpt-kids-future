...
<div class="container main-page d-flex justify-content-center flex-wrap p-3 text-center">
    ...
    <div class="container d-flex justify-content-center content mb-5 mt-3 text-center">
        <form method="post" action="{{ route('users.hobbiesstore') }}" class="align-content-center">
            @csrf
            <div class="container mb-5">
                <label class="form-label mt-5 " for="typeText"><span class="main-color fa-2x">هوايتك المفضلة؟</span></label>
            </div>

            <div class="container d-flex justify-content-center flex-wrap">
                <div class="button mb-4">
                    <input type="radio" id="subject" name="hobby" value="football" />
                    <label class="btn btn-default third-color" for="a25">كره القدم</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" id="subject" name="hobby" value="swimming" />
                    <label class="btn btn-default third-color" for="a25">السباحه</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" name="hobby" value="video games" />
                    <label class="btn btn-default third-color" for="a25">العاب الفيديو</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" name="hobby" value="Drawing" />
                    <label class="btn btn-default third-color" for="a25">الرسم</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" name="hobby" value="Writing" />
                    <label class="btn btn-default third-color" for="a25">الكتابة</label>
                </div>
                <div class="button mb-4">
                    <input type="radio" name="hobby" value="Design" />
                    <label class="btn btn-default third-color" for="a25">التصميم</label>
                </div>
            </div>
