...
<div class="container main-page d-flex justify-content-center flex-wrap p-3 text-center">
    ...
    <div class="container mt-5 mb-5">
        <div class="img-fluid">
            <svg id="que" xmlns="http://www.w3.org/2000/svg" width="315.82" height="205.724" viewBox="0 0 315.82 205.724">
    ...
    <!-- content -->
    <div class="container d-flex justify-content-center content mb-5 text-center">
        <form action="{{ route('users.namestore') }}" method="post" class="w-75 mt-5">
            @csrf
            <label class="form-label mt-5 mb-3" for="typeText"><span class="main-color fa-2x">ايش اسمك؟</span></label>
            <div class="">
                <input type="text" id="typeText" name="name" class="form-control rounded-pill" />
            </div>
